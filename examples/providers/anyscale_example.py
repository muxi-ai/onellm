...
def streaming_example():
    ...
    stream = client.chat.completions.create(
        ...
        messages=[{"role": "user", "content": "Explain distributed computing in simple terms."}],
        stream=True,
        max_tokens=150,
    )
...
def json_mode_with_schema():
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "user", "content": "Create information about a distributed computing system."},
        ],
        response_format={
            "type": "json_object",
            "schema": {
...
def open_source_models_showcase():
    ...
    model_examples = [
        ...
        {"model": "anyscale/mixtral-8x22b", "prompt": "What are mixture of experts models?"},
    ]
