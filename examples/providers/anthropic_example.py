...
def basic_chat_completion():
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "user", "content": "What makes Claude unique compared to other AI assistants?"}
        ],
        max_tokens=200,
        temperature=0.7
    )
...
def multi_turn_conversation():
    ...
    messages = [
        ...
        {"role": "assistant", "content": "Hello! That's great to hear. Python is an excellent language to learn. What aspects of Python are you currently focusing on?"},
        {"role": "user", "content": "I'm trying to understand decorators. Can you explain them simply?"}
    ]
...
def json_output_example():
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {
                "role": "user",
                "content": "Create a JSON object with information about 3 planets in our solar system."
            }
        ],
        max_tokens=300
    )
