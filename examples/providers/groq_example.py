...
def basic_chat_completion():
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "user", "content": "What are the benefits of using Groq's LPU for AI inference?"}
        ],
        temperature=0.7,
        max_tokens=200
    )
...
def streaming_example():
    ...
    stream = client.chat.completions.create(
        ...
        messages=[
            {"role": "user", "content": "Count from 1 to 10 with a brief description of each number."}
        ],
        stream=True,
        max_tokens=300
    )
...
def json_mode_example():
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {
                "role": "user",
                "content": "Create a JSON object with 3 fast food restaurants and their popular items."
            }
        ],
