...
def basic_chat_completion():
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {
                "role": "user",
                "content": "What are the benefits of using Vertex AI for enterprise ML?",
            },
        ],
        temperature=0.7,
        max_tokens=200,
...
def json_mode_example():
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {
                "role": "user",
                "content": "Create a JSON object with Google Cloud's AI/ML services hierarchy.",
            },
        ],
...
def enterprise_features_example():
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            {
                "role": "system",
                "content": "You are an enterprise AI assistant with knowledge of compliance and security.",  # noqa: E501
            },
            {
                "role": "user",
                "content": "What are the key compliance and security features of Vertex AI for regulated industries?",  # noqa: E501
            },
        ],
        max_tokens=300,
    )
...
def code_generation_example():
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            {
                "role": "user",
                "content": "Write a Python function to interact with Google Cloud Storage using the google-cloud-storage library.",  # noqa: E501
            }
        ],
        temperature=0.2,
        max_tokens=400,
    ...
    for i, item in enumerate(items):
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are a sentiment classifier. Respond with only: POSITIVE, NEGATIVE, or NEUTRAL",  # noqa: E501
                },
