...
def basic_chat_completion():
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {
                "role": "user",
                "content": "What makes Together AI special for running open-source models?",
            },
        ],
        temperature=0.7,
        max_tokens=200,
...
def json_mode_example():
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {
                "role": "user",
                "content": "Create a JSON object with information about 3 popular open-source LLMs.",  # noqa: E501
            },
        ],
...
def function_calling_example():
    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[{"role": "user", "content": "How many parameters does Llama 3 70B have?"}],
            tools=tools,
            tool_choice="auto",
        )
        ...
        try:
            response = client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "user",
                        "content": "Write a Python function to find all prime numbers up to n using the Sieve of Eratosthenes.",  # noqa: E501
                    }
                ],
                temperature=0.2,
                max_tokens=400,
