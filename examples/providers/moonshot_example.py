...
def basic_chat_completion():
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {
                "role": "user",
                "content": "What makes Moonshot's Kimi models unique in the AI landscape?",
            },
        ],
        temperature=0.7,
        max_tokens=200,
...
def long_context_example():
    ...
    The field has seen significant advances in large language models, with improvements in
    reasoning, code generation, and multilingual capabilities.
    Companies like OpenAI, Anthropic, Google, and Chinese companies like
    Moonshot AI have made substantial contributions.
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            {
                "role": "user",
                "content": f"Please summarize this document in 2-3 sentences: {long_document}",
            }
        ],
        max_tokens=100,
    )
        ...
        messages=[
            {
                "role": "user",
                "content": (
                    "Write a Python function to convert temperature between Celsius, "
...
def json_output_example():
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {
                "role": "user",
                "content": "Create a JSON object with information about 3 major Chinese tech companies.",  # noqa: E501
            },
        ],
        max_tokens=300,
    )
...
def conversation_example():
    ...
    messages = [
        ...
        {
            "role": "assistant",
            "content": "That's wonderful! Chinese culture is rich and diverse, spanning over 5,000 years. What aspect interests you most - history, philosophy, art, cuisine, or modern culture?",  # noqa: E501
        },
        {"role": "user", "content": "Tell me about Chinese philosophy, especially Confucianism."},
    ]

    response = client.chat.completions.create(
        model="moonshot/moonshot-v1-8k", messages=messages, max_tokens=300
    )
